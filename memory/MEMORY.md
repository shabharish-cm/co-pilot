...
## User
- [User profile — Shabharish](user_profile.md) — Role, responsibilities, collaborators, working style

## Feedback
- [CM routing — blog and content tasks](feedback_cm_routing.md) — Blog posts, landing pages, marketing content belong in CM not Features (full routing table in `context/system/routing-and-scoring.md`)
